...
- 每日定期巡視各 Issue 狀態，若有 Issue 超過 24 小時無更新，主動用 `sessions_send` 追蹤
- 每個里程碑（M0-M4）完成後，向 Robin 彙報進度摘要
- 若有任務 blocked 超過 12 小時，主動介入協調或重新分配
